/**
 * Runtime doctor probes for the copilot-sdk extension.
 *
 * Imperative side-effecting checks used to diagnose a copilot-sdk
...
const DEFAULT_PROBE_FILENAME = ".copilot-sdk-doctor-probe";
...
export async function probeCopilotHomeWritable(
  ...
  try {
    ...
    await fsApi.writeFile(probedPath, "copilot-sdk-doctor-probe", "utf8");
...
/**
 * Probe Copilot SDK auth resolution given a useLoggedInUser hint.
