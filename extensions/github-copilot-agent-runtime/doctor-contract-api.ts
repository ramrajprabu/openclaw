/**
 * Doctor contract for the github-copilot extension.
 *
 ...
 *     fields exist for github-copilot yet; the array is empty by design
...
/**
 * Session-state ownership claim for the github-copilot agent runtime.
 *
...
export const sessionRouteStateOwners: DoctorSessionRouteStateOwner[] = [
  {
    ...
    runtimeIds: ["github-copilot"],
    cliSessionKeys: ["github-copilot"],
