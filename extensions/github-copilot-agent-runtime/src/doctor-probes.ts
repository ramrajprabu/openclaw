/**
 * Runtime doctor probes for the github-copilot extension.
 *
 * Imperative side-effecting checks used to diagnose a github-copilot
...
const DEFAULT_PROBE_FILENAME = ".github-copilot-doctor-probe";
...
export async function probeCopilotHomeWritable(
  ...
  try {
    ...
    await fsApi.writeFile(probedPath, "github-copilot-doctor-probe", "utf8");
